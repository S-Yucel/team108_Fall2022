...
public class C03_StringSplitMetodu {
    public static void main(String[] args) {
        ...
        // istedigimiz ayracı kullanarak ayırmamıza imkan verir

        str.split(" ");
        String[] spaceSplit = str.split(" ");
        System.out.println(Arrays.toString(spaceSplit)); //[Java, her, gecen, gun, guzellesiyor]
        System.out.println("Verilen cumledeki kelime sayısı : " + spaceSplit.length); // Verilen cumledeki kelime sayısı : 5
